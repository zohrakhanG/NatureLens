...
import * as Notification_alert from 'expo-notifications';
...
import Identify_Results from "./Screens/Identify_Results";
import Diagnose_Results from "./Screens/Diagnose_Results";
import Community from "./Screens/Community";
import Add_post from "./Screens/Add_post";
import Comments_screen from "./Screens/Comments_screen";
import { WeatherProvider } from "./Screens/WeatherContext";
import ChangeLang from "./Screens/ChangeLang";

Notification_alert.setNotificationHandler({
...
export default function App() 
{
  ...
  const { status } =
    await Notification_alert.requestPermissionsAsync();
  ...
  useEffect(() => {
    const backAction = () => {
      ...
      if ([
        ...
        "Home1","SignIn","SignUp", "Identify_Results", "Diagnose_Results", "ThankYou"
      ].includes(routeName)) 
      {
        return true;
      }
      ...
      >    
        <InactivityHandler currentRoute={currentRoute}>
          <Stack.Navigator initialRouteName="SignIn" screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="Identify_Results" component={Identify_Results} />
            <Stack.Screen name="Diagnose_Results" component={Diagnose_Results} />
            <Stack.Screen name="Community" component={Community} />
            <Stack.Screen name="Add_post" component={Add_post} />
            <Stack.Screen name="Comments_screen" component={Comments_screen} />
            <Stack.Screen name="ChangeLanguage" component={ChangeLang}/>
