...
const confirmPhoto = async () => {
  ...
  try {
    ...
    const response = await fetch("http://192.168.100.58:8000/api/predict/", {
      method: "POST",
      body: formData,
    });
    ...
    navigation.navigate("Identify_Results", { 
      plant: data,
      photoUri: photoUri 
    });
    ...
    setLoading(false); // hide overlay (optional if navigating away)
  }
};
