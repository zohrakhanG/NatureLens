...
export default function Diagnose_Results({ route, navigation }) 
{
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.title}>
          {plant.top5_predictions && plant.top5_predictions.length > 0
            ? plant.top5_predictions[0].plant
            : plant.prediction || t("unknownPlant")}
        </Text>
      ...
      >
        <Text style={styles.diagnoseButtonText}>{t("diagnoseAgain")}</Text>
      </TouchableOpacity>
